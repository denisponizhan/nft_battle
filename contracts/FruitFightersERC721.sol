    ...
    IERC721Metadata
{
        ...
        returns (uint256)
    {
        ...
        return _ownerFruitFighterCount[owner];
    }
    ...
    function ownerOf(uint256 tokenId)
        ...
        returns (address)
    {
        address owner = _fruitFighterToOwner[tokenId];
        require(
            owner != address(0),
    ...
    function _exists(uint256 tokenId) internal view virtual returns (bool) {
        return _fruitFighterToOwner[tokenId] != address(0);
    }
    ...
    function _transfer(
        ...
        _ownerFruitFighterCount[from] -= 1;
        _ownerFruitFighterCount[to] += 1;
        _fruitFighterToOwner[tokenId] = to;
